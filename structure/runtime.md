...
| `src/config/process-state.ts` | Owns `ocx.pid`, `runtime-port.json`, the optional boot package and service-manager identity used by conditional refresh, cheap liveness, full command-line identity verification, and snapshot-guarded cleanup. |
