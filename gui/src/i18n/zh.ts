...
"common.discard": "丢弃",
  ...
  "models.subtitle": "所有提供方：选择在 Codex 中显示的模型 ID。开关适用于提供完全相同 ID 的所有提供方，包括以后新增的提供方。特定提供方的可见性在提供方页面设置。",
...
"codexSet.dialog.notRendered": "在我们读取的那一轮中，此层没有发送任何内容。各部分仅在内容变化时才会重新发送，因此单次采样可能看不到它。",
 ...
 "quota.fiveHourLimit": "5 小时限额",
  ...
  "pws.modelCopied": "已复制！",
  "pws.modelsListed": "显示 {visible}/{total} 个",
  "pws.modelsRelationship": "此处设置仅适用于当前提供方。模型页面控制所有提供方的相同模型 ID。",
  "pws.hiddenForProvider": "在此提供方隐藏",
  "pws.showForProvider": "在此提供方显示",
  "pws.globallyHidden": "在所有提供方隐藏",
  "pws.modelShown": "已在此提供方显示模型。",
  "models.globalVisibilityLabel": "在所有提供方显示 {model}",
  "models.providerHidden": "在此提供方隐藏",
