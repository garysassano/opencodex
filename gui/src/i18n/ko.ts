...
"common.discard": "버리기",
  ...
  "models.subtitle": "모든 제공업체: Codex에 표시할 모델 ID를 선택합니다. 스위치는 현재와 나중에 추가되는 모든 제공업체의 동일한 ID에 적용됩니다. 제공업체별 표시는 제공업체 페이지에서 설정합니다.",
...
"codexSet.dialog.notRendered": "확인한 턴에서는 이 레이어가 아무것도 보내지 않았습니다. 각 섹션은 내용이 바뀔 때만 다시 전송되므로, 한 번 확인한 것만으로는 빠져 보일 수 있습니다.",
 ...
 "quota.fiveHourLimit": "5시간 한도",
  ...
  "pws.modelCopied": "복사됨!",
  "pws.modelsListed": "{total}개 중 {visible}개 표시",
  "pws.modelsRelationship": "여기 설정은 이 제공업체에만 적용됩니다. 모델 페이지에서는 모든 제공업체의 동일한 모델 ID를 제어합니다.",
  "pws.hiddenForProvider": "이 제공업체에서 숨김",
  "pws.showForProvider": "이 제공업체에서 표시",
  "pws.globallyHidden": "모든 제공업체에서 숨김",
  "pws.modelShown": "이 제공업체에서 모델을 표시했습니다.",
  "models.globalVisibilityLabel": "모든 제공업체에서 {model} 표시",
  "models.providerHidden": "이 제공업체에서 숨김",
