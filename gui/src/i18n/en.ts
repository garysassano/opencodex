...
"common.discard": "Discard",
  ...
  "models.subtitle": "All providers: choose which model IDs appear in Codex. A switch applies to every provider offering that exact ID, including providers added later. Provider-specific visibility is on Providers.",
 ...
 "quota.fiveHourLimit": "5-hour limit",
  ...
  "pws.modelsListed": "{visible} of {total} listed",
  "pws.modelsRelationship": "Provider controls here apply only to this provider. Models controls the same model ID across all providers.",
  "pws.hiddenForProvider": "Hidden for this provider",
  "pws.showForProvider": "Show for this provider",
  "pws.globallyHidden": "Hidden across providers",
  "pws.modelShown": "Model shown for this provider.",
  "models.globalVisibilityLabel": "Show {model} across providers",
  "models.providerHidden": "Hidden for this provider",
