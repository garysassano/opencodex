...
"common.discard": "破棄",
  ...
  "models.subtitle": "すべてのプロバイダー: Codex に表示するモデル ID を選びます。スイッチは同じ ID を提供するすべてのプロバイダーに適用され、後から追加したプロバイダーも対象です。個別の表示設定はプロバイダーで行います。",
 ...
 "quota.fiveHourLimit": "5 時間上限",
  ...
  "pws.modelsListed": "{total} 件中 {visible} 件を表示",
  "pws.modelsRelationship": "ここでの設定はこのプロバイダーのみに適用されます。モデルページでは同じモデル ID をすべてのプロバイダーで制御します。",
  "pws.hiddenForProvider": "このプロバイダーで非表示",
  "pws.showForProvider": "このプロバイダーで表示",
  "pws.globallyHidden": "すべてのプロバイダーで非表示",
  "pws.modelShown": "このプロバイダーでモデルを表示しました。",
  "models.globalVisibilityLabel": "すべてのプロバイダーで {model} を表示",
  "models.providerHidden": "このプロバイダーで非表示",
